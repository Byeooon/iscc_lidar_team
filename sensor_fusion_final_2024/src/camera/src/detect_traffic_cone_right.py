...
class Yolov7Publisher:
    def __init__(self):
        ...
        self.visualization_right_publisher = rospy.Publisher(
            "/traffic_cone_yolo_right_result", Image, queue_size= 1
        )
        ...
        self.subscriber_right = rospy.Subscriber(
            "/usb_cam_right/image_raw", Image, self.process_img_msg_right
        )

        self.boundingbox_publisher = rospy.Publisher("/traffic_cone_bbox_class_right", YoloTrafficCone, queue_size=1)
    ...
    def process_img_msg_right(self, img_msg):
        ...
        self.visualization_right_publisher.publish(vis_msg)
