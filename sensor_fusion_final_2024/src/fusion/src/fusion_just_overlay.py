...
class LIDAR2CAMTransform:
    def __init__(self,params_cam,params_lidar):
        ...
        self.cluster_sub = rospy.Subscriber("/cluster",PointCloud2,self.callback)
        self.img_pub = rospy.Publisher("/fusion_result_center", Image, queue_size= 1)
        self.global_frame = None

    def img_callback(self, msg):
        bridge = CvBridge()
        self.global_frame = bridge.imgmsg_to_cv2(msg, desired_encoding='bgr8')
    ...
    def callback(self, msg):
        ...
        self.point_image = self.project_pts2img(self.point_camera)
    ...
    def camera(self, xyz_i):
        for i in range(2):
            ...
            xi = xi.flatten()
            yi = yi.flatten()
            result = self.draw_pts_img(self.global_frame, xi, yi)
...
if __name__ == "__main__" :
    ...
    # params_cam = {"WIDTH": 1280, "HEIGHT":720, "FOV":78, "X": -0.09, "Y": 0.29, "Z": 0.185}
