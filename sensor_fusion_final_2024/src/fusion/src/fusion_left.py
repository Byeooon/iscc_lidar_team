...
class create_matrix:
    ...
    def transformMTX_lidar2cam(self, params_lidar, params_cam):
        ...
        # R_T = np.matmul(R_T, self.rotationMtx(0., 0., np.deg2rad(30.))) # 위로 최대 올림 
...
class LIDAR2CAMTransform:
    def __init__(self,params_cam,params_lidar):
        ...
        self.image_pub = rospy.Publisher("/fusion_result_left",Image,queue_size= 1)
        ...
        self.yolo_sub = rospy.Subscriber("/traffic_cone_yolo_left_result",Image,self.image_callback)
        self.bbox_sub = rospy.Subscriber("/traffic_cone_bbox_class_left",YoloTrafficCone,self.bbox_callback)
        self.frame = None
    ...
    def bbox_callback(self, msg): 
        ...
        if len(self.point_x) == 0:
            ...
            if len(self.point_x) != len(self.point_y):
...
if __name__ == "__main__" :
    ...
    params_cam = {"WIDTH": 640, "HEIGHT": 480, "FOV": 78, "X": 0, "Y": 0.2, "Z": 0.023} # erp42 , left > 0
