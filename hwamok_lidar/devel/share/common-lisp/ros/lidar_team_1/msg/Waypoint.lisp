...
(cl:defmethod cl:initialize-instance :after ((m <Waypoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Waypoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_team_1-msg:<Waypoint> is deprecated: use lidar_team_1-msg:Waypoint instead.")))

(cl:ensure-generic-function 'cnt-val :lambda-list '(m))
(cl:defmethod cnt-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_team_1-msg:cnt-val is deprecated.  Use lidar_team_1-msg:cnt instead.")
  (cnt m))

(cl:ensure-generic-function 'x_arr-val :lambda-list '(m))
(cl:defmethod x_arr-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_team_1-msg:x_arr-val is deprecated.  Use lidar_team_1-msg:x_arr instead.")
  (x_arr m))

(cl:ensure-generic-function 'y_arr-val :lambda-list '(m))
(cl:defmethod y_arr-val ((m <Waypoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_team_1-msg:y_arr-val is deprecated.  Use lidar_team_1-msg:y_arr instead.")
  (y_arr m))
