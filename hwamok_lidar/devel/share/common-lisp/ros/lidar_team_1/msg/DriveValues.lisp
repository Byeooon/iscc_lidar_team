...
(cl:defmethod cl:initialize-instance :after ((m <DriveValues>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveValues)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_team_1-msg:<DriveValues> is deprecated: use lidar_team_1-msg:DriveValues instead.")))

(cl:ensure-generic-function 'throttle-val :lambda-list '(m))
(cl:defmethod throttle-val ((m <DriveValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_team_1-msg:throttle-val is deprecated.  Use lidar_team_1-msg:throttle instead.")
  (throttle m))

(cl:ensure-generic-function 'steering-val :lambda-list '(m))
(cl:defmethod steering-val ((m <DriveValues>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_team_1-msg:steering-val is deprecated.  Use lidar_team_1-msg:steering instead.")
  (steering m))
