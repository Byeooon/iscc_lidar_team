...
(cl:defmethod cl:initialize-instance :after ((m <Boundingbox>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Boundingbox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_team_1-msg:<Boundingbox> is deprecated: use lidar_team_1-msg:Boundingbox instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Boundingbox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_team_1-msg:x-val is deprecated.  Use lidar_team_1-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Boundingbox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_team_1-msg:y-val is deprecated.  Use lidar_team_1-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Boundingbox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_team_1-msg:z-val is deprecated.  Use lidar_team_1-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'volume-val :lambda-list '(m))
(cl:defmethod volume-val ((m <Boundingbox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_team_1-msg:volume-val is deprecated.  Use lidar_team_1-msg:volume instead.")
  (volume m))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <Boundingbox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_team_1-msg:distance-val is deprecated.  Use lidar_team_1-msg:distance instead.")
  (distance m))
