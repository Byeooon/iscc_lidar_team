...
(cl:defmethod cl:initialize-instance :after ((m <Delivery>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Delivery)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_team_1-msg:<Delivery> is deprecated: use lidar_team_1-msg:Delivery instead.")))
...
(cl:defmethod angle-val ((m <Delivery>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_team_1-msg:angle-val is deprecated.  Use lidar_team_1-msg:angle instead.")
  (angle m))
