...
(cl:defmethod cl:initialize-instance :after ((m <DynamicVelocity>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DynamicVelocity)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_team_1-msg:<DynamicVelocity> is deprecated: use lidar_team_1-msg:DynamicVelocity instead.")))
